...
VOTES = [
    ...
    ("PE-HTV-147044", "taxe-impots", "Blocages nationaux de l'impôt mondial (UE, 2022)",
     ...
     "Résolution du 6 juillet 2022. Côté français : 52 élus pour, 16 contre — les élus du RN (groupe Identité et démocratie) et deux non-inscrits élus sur une liste RN, Nicolas Bay et Maxette Pirbakas."),
    ...
    ("VTANR5L17V3686", "travail", "Congé de naissance réservé aux couples dont un parent est français (2025)",
     ...
     "Amendement déposé par la députée Angélique Ranc (Rassemblement national) avec 159 cosignataires, rejeté par 147 voix contre 68. Seuls le Rassemblement national et l'Union des droites pour la République l'ont soutenu ; tous les autres groupes ont voté contre. Un second amendement du même groupe, visant à inscrire une condition de six mois d'activité cotisée, a également été rejeté (scrutin n°3687), le Gouvernement et la rapporteure le jugeant déjà satisfait : le congé étant une prestation contributive, il est déjà soumis aux conditions d'affiliation des indemnités journalières de maternité."),
    ...
    ("PE-HTV-144789", "ecologie-agriculture", "Quotas CO₂ pour l'aviation (UE, 2022)",
     ...
     "Vote du 8 juin 2022 fixant la position de négociation du Parlement. Côté français : 52 élus pour, 15 contre — les élus du RN (groupe Identité et démocratie), à l'exception de Thierry Mariani qui s'est abstenu, ainsi que deux non-inscrits élus sur la liste RN, Nicolas Bay et Jérôme Rivière."),
