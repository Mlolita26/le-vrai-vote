...
VOTES = [
    ...
    ("VTANR5L15V139", "ecologie-agriculture", "Fin des hydrocarbures (2017)",
     "Programme la fin de la recherche et de l'exploitation du pétrole et du gaz sur le territoire français : plus aucun nouveau permis exclusif de recherches, et les concessions d'exploitation ne peuvent plus être prolongées au-delà du 1ᵉʳ janvier 2040. Le texte adopté prévoit deux limites : les titulaires d'un permis de recherches en cours conservent le droit d'obtenir une concession, et celle-ci peut dépasser 2040 si son titulaire démontre que cette échéance ne lui permet pas de couvrir ses coûts. La France produisant très peu d'hydrocarbures, l'effet sur l'approvisionnement est limité : l'enjeu porte surtout sur le signal d'une sortie programmée des énergies fossiles.",
     None),
    ...
    ("VTANR5L17V8427", "ecologie-agriculture", "Loi d'urgence pour la protection et la souveraineté agricoles (2026)",
     "Vise à soutenir l'agriculture française face aux crises climatiques et à la concurrence internationale : fixe un objectif de doublement des volumes de stockage d'eau agricole d'ici 2035 et facilite l'instruction de ces projets, sanctionne l'importation de denrées ne respectant pas les suspensions prises pour cause de substances interdites dans l'Union, impose que la restauration collective publique ne serve que des produits originaires de l'Union européenne sauf offre insuffisante, encadre la négociation entre agriculteurs et premiers acheteurs par un délai de quatre mois suivi d'une médiation, et permet aux porteurs de certains projets d'obtenir réparation en cas de recours jugé abusif. Autorise enfin, à titre dérogatoire et pour un an renouvelable deux fois, deux substances interdites sur des cultures précisément désignées : l'acétamipride (un néonicotinoïde) sur les noisettes, et le flupyradifurone sur les betteraves sucrières, les cerises et les pommes. L'Anses statue dans un délai de deux mois, sous conditions (absence d'alternative, plan de recherche, absence de risque significatif) ; ce dispositif est abrogé trois ans après la promulgation. L'enjeu : la compétitivité de l'agriculture française, mise en balance avec la protection de l'eau, des pollinisateurs et de la santé.",
     "Adopté une première fois le 2 juin 2026 (scrutin n°7259 : 369 pour, 178 contre, 15 abstentions), puis, sur le texte de compromis de la commission mixte paritaire, le 20 juillet 2026 (scrutin n°8427 : 296 pour, 224 contre, 41 abstentions) : c'est ce second vote, définitif à l'Assemblée, qui est affiché ici. Reprend, sur les pesticides, un dispositif proche de celui de la loi Duplomb (2025), partiellement censuré par le Conseil constitutionnel après son adoption. Les dérogations aux pesticides ne figuraient pas dans le texte adopté par l'Assemblée le 2 juin 2026 : elles ont été introduites au cours de la navette. Le Conseil constitutionnel, de nouveau saisi le 24 juillet 2026, ne s'était pas prononcé à la date de mise à jour du site."),
    ...
    ("VTANR5L16V1545", "ecologie-agriculture", "Entretien des chemins forestiers contre les incendies (2023)",
     "Amendement à la proposition de loi sur le risque incendie inscrivant dans les schémas régionaux de gestion sylvicole les opérations de débroussaillement et d'élagage exclusivement nécessaires à l'entretien de l'accès aux itinéraires sylvicoles, aux ouvrages de défense de la forêt contre les incendies et à la circulation des véhicules de secours. L'enjeu : préserver les accès utiles à la lutte contre les feux, tout en limitant les coupes de végétation à ce qui relève de cette prévention.",
     None),
    ("VTANR5L16V1556", "ecologie-agriculture", "Pare-feux d'arbres feuillus (2023)",
     ...
     None),
    ("VTANR5L17V4114", "ecologie-agriculture", "Part de la taxe sur les assurances reversée aux pompiers (2025)",
     "Amendement au budget 2026 portant de 6,45 % à 10,45 % la fraction de la taxe spéciale sur les conventions d'assurance affectée aux départements, et précisant que son produit contribue au financement des services départementaux d'incendie et de secours (SDIS). Le taux payé par les assurés reste inchangé : la mesure transfère aux départements une part plus importante d'une taxe déjà perçue, au détriment du budget de l'État. L'enjeu : donner aux pompiers des ressources plus stables face à des feux plus fréquents et plus intenses, mis en balance avec la perte de recettes pour l'État.",
     None),
    ...
    ("VTANR5L16V3782", "ecologie-agriculture", "Développement de l'élevage en pâturage et plein air (2024)",
     "Sous-amendement à la loi d'orientation agricole ajoutant aux objectifs de la politique agricole le fait d'enrayer l'élevage sans accès au pâturage et l'élevage en cage, et de développer l'élevage herbager, en plein air et pâturant. Il s'agit d'une orientation inscrite dans les objectifs de la loi, sans obligation directe pour les exploitants. L'enjeu : la place des modes d'élevage extensifs, mise en balance avec les contraintes économiques des filières.",
     None),
    ...
    ("VTANR5L17V3958", "ecologie-agriculture", "Fin de la taxation réduite du charbon pour les entreprises énergo-intensives (2025)",
     "Amendement au budget 2026 supprimant progressivement, entre 2026 et 2028, le tarif réduit d'accise sur le charbon dont bénéficient les installations grandes consommatrices d'énergie soumises au marché carbone européen. Le tarif serait passé de 4,39 €/MWh à 7,71 € en 2026, 11,01 € en 2027 puis 15,43 € en 2028, niveau du tarif normal. L'enjeu : renchérir l'usage d'une énergie fossile très émettrice, mis en balance avec la compétitivité de ces industries.",
     None),
    ...
    ("VTANR5L17V144", "ecologie-agriculture", "TVA à 5,5 % sur le gaz, l'électricité, le fioul et les carburants (2024)",
     ...
     None),
    ("VTANR5L17V3830", "ecologie-agriculture", "Suppression des malus CO2 et au poids sur les véhicules (2025)",
     "Amendement au budget 2026 supprimant les deux malus dus lors de la première immatriculation en France d'un véhicule de tourisme : la taxe sur les émissions de CO2 (« malus écologique ») et la taxe sur la masse en ordre de marche (« malus au poids »). L'enjeu : le pouvoir d'achat des ménages achetant un véhicule thermique, mis en balance avec l'incitation à acheter des véhicules moins polluants et moins lourds, et avec la perte de recettes pour l'État (3,3 milliards d'euros selon les auteurs de l'amendement).",
     None),
    ...
    ("VTANR5L16V186", "pouvoir-achat-fiscalite", "Mesures d'urgence pouvoir d'achat (2022)",
     "Ensemble de mesures adoptées face à la forte inflation de 2022 : revalorisation anticipée des retraites et de plusieurs prestations sociales, plafonnement temporaire de la hausse des loyers à 3,5 %, et primes exonérées de cotisations que les employeurs peuvent verser à leurs salariés. Le texte comporte aussi un volet énergie : autorisation d'un terminal méthanier flottant au Havre et relèvement temporaire du plafond d'émissions des centrales à charbon en cas de menace sur la sécurité d'approvisionnement en électricité. L'enjeu : soutenir rapidement le pouvoir d'achat des ménages, le débat portant sur l'ampleur de ces mesures, leur coût pour les finances publiques et les concessions faites aux énergies fossiles.",
    ...
    ("VTANR5L17V881", "taxe-impots", "Impôt plancher sur les très hauts patrimoines (2025)",
     "Crée un impôt minimum : les foyers dont le patrimoine dépasse 100 millions d'euros devraient payer chaque année au moins 2 % de ce patrimoine en impôt (proposition dite « taxe Zucman », du nom de l'économiste). Le montant dû correspond à 2 % du patrimoine net taxable, diminué des impôts déjà payés. Le texte adopté prévoit aussi que les personnes domiciliées fiscalement en France depuis plus de dix ans restent imposées sur leur patrimoine mondial pendant plusieurs années après leur départ. L'idée de départ est que certaines très grandes fortunes paient aujourd'hui, en proportion, moins d'impôt que le reste de la population. L'enjeu : de nouvelles recettes et davantage de progressivité de l'impôt, mis en regard de la difficulté à évaluer et à taxer un patrimoine qui n'a pas été vendu, et du débat sur l'efficacité de la clause visant les départs à l'étranger.",
    ...
    ("VTANR5L15V138", "securite-justice", "Sécurité intérieure et lutte contre le terrorisme (2017)",
     "Fait entrer dans le droit commun quatre dispositifs jusque-là réservés à l'état d'urgence : périmètres de protection autour de lieux ou d'événements, fermeture administrative de lieux de culte, mesures individuelles de contrôle et de surveillance décidées par le ministre de l'intérieur, et visites domiciliaires avec saisies, autorisées au préalable par un juge des libertés et de la détention. Dans le texte adopté, les deux derniers dispositifs sont expérimentaux : applicables jusqu'au 31 décembre 2020, avec un rapport annuel au Parlement. L'enjeu : disposer d'outils antiterroristes hors état d'urgence, et le degré de contrôle du juge sur des mesures décidées par l'administration.",
     "Ces mesures, expérimentales jusqu'au 31 décembre 2020, ont été pérennisées par une loi de juillet 2021, quatre ans après ce vote."),
    ("VTANR5L15V3254", "securite-justice", "Loi « sécurité globale » (2020)",
     "Élargit les pouvoirs des polices municipales et des agents de sécurité privée, développe la vidéosurveillance et encadre l'usage des drones par les forces de l'ordre, et crée un délit de diffusion d'images de policiers ou de gendarmes dans le but manifeste de porter atteinte à leur intégrité physique ou psychique. L'enjeu : renforcer la sécurité du quotidien ; la mesure sur les images des forces de l'ordre a fait débat sur la liberté d'informer et de filmer leur action.",
     None),
    ...
    ("VTANR5L17V7987", "securite-justice", "Présomption de légitime défense des forces de l'ordre (2026)",
     "Instaure, dans le code de la sécurité intérieure, une présomption au bénéfice des policiers nationaux et des gendarmes qui font usage de leur arme : ils sont présumés avoir agi dans l'un des cas où la loi les autorise à tirer, et dans le respect des conditions d'absolue nécessité et de stricte proportionnalité. Le texte précise que cette présomption peut être renversée à tout moment par tout élément de preuve contraire. Il réécrit par ailleurs le cas dit du « périple meurtrier » sans en modifier les conditions. L'enjeu : la charge de la preuve dans les enquêtes ouvertes après un tir policier, mise en balance avec le contrôle exercé sur l'usage d'une arme pouvant donner la mort.",
     "Adoptée en première lecture le 7 juillet 2026 ; la navette parlementaire se poursuit au Sénat. Le dispositif initial, qui inscrivait une présomption de légitime défense dans le code pénal et couvrait aussi la police municipale, a été supprimé en séance et remplacé par celui décrit ci-dessus. Ses opposants qualifient le texte de « permis de tuer », ses partisans de protection nécessaire des agents. Ce sont des qualifications rapportées, que le site ne reprend pas à son compte."),
    ...
    ("VTANR5L17V7405", "immigration", "Sécurité et rétention administrative (2026)",
     "Loi transversale sécurité et immigration. Sur la rétention administrative (l'enfermement, hors prison, en attendant l'expulsion) : porte de 30 à 90 jours la durée de prolongation de droit commun, permet d'aller au-delà pour un étranger représentant une menace d'une particulière gravité et condamné définitivement, plafonne la durée cumulée à 360 jours (540 dans ce dernier cas), pour cinq placements au plus. Sur le volet antiterroriste : crée une « rétention de sûreté terroriste », placement après l'exécution de la peine dans un centre socio-médico-judiciaire pour des personnes condamnées à au moins quinze ans de réclusion et jugées particulièrement dangereuses ; permet au préfet d'imposer un examen psychiatrique à une personne radicalisée susceptible de souffrir de troubles mentaux ; crée une mesure judiciaire de suivi pour des condamnés de droit commun radicalisés ; encadre les changements de nom et de prénom des personnes inscrites aux fichiers judiciaires. L'enjeu : donner plus de temps et de moyens à l'administration, mis en balance avec la privation de liberté que représentent ces mesures.",
     "Texte de la commission mixte paritaire, rattaché ici à son objet principal (règle « un vote = un thème »). Saisi par plus de soixante députés, le Conseil constitutionnel l'a déclaré conforme le 23 juillet 2026 sans censurer aucune disposition, en assortissant plusieurs articles de réserves d'interprétation. Promulguée le 27 juillet 2026."),
    ...
    ("VTCGR5L16V1", "femmes", "IVG dans la Constitution (Congrès, 2024)",
     ...
     "Adopté par le Parlement réuni en Congrès à Versailles par 780 voix pour et 72 contre, sur 902 votants et 852 suffrages exprimés : les 50 voix restantes sont des bulletins blancs ou nuls. C'est le seul vote de la base où députés et sénateurs sont directement comparables. Faute de page officielle de scrutin pour le Congrès, le lien renvoie à un compte rendu de presse."),
    ...
    ("VTANR5L17V8280", "sante", "Droit à l'aide à mourir (2026)",
     "Crée un « droit à l'aide à mourir » : la possibilité, pour une personne majeure, de nationalité française ou résidant régulièrement en France, atteinte d'une affection grave et incurable engageant son pronostic vital en phase avancée ou terminale, et présentant une souffrance liée à cette affection soit réfractaire aux traitements soit qu'elle juge insupportable, de se voir prescrire une substance létale qu'elle s'administre elle-même ou, si elle n'en est physiquement pas capable, que lui administre un médecin ou un infirmier. Une souffrance psychologique seule ne peut jamais y ouvrir droit. La décision est prise par le médecin à l'issue d'une procédure collégiale, puis la personne doit confirmer sa demande après un délai de réflexion. L'enjeu : pouvoir choisir sa fin de vie face à des souffrances jugées insupportables, mis en regard des inquiétudes éthiques sur la protection des personnes les plus vulnérables.",
     "Lecture définitive du 15 juillet 2026, au terme de quatre lectures à l'Assemblée, la commission mixte paritaire ayant échoué. Le texte a ensuite été soumis au Conseil constitutionnel et n'était pas promulgué à la date de mise à jour du site."),
    ...
    ("VTANR5L14V1070", "societe", "Fin de vie : loi Claeys-Leonetti (2015)",
     ...
     "Première lecture ; le texte a été définitivement adopté début 2016. C'est ce cadre que doit compléter la proposition de loi sur le droit à l'aide à mourir, adoptée définitivement le 15 juillet 2026 : ce texte a été soumis au Conseil constitutionnel et n'était pas promulgué à la date de mise à jour du site."),
    ...
    ("VTANR5L14V1237", "immigration", "Déchéance de nationalité : « protection de la Nation » (2016)",
     "Projet de révision de la Constitution qui voulait y inscrire l'état d'urgence et permettre à la loi de retirer la nationalité française, ou les droits qui y sont attachés, à une personne condamnée pour un crime ou un délit constituant une atteinte grave à la vie de la Nation. Le texte initial du Gouvernement ne visait que les personnes nées françaises détenant une autre nationalité ; la rédaction adoptée par l'Assemblée a supprimé cette condition de double nationalité et étendu le dispositif aux délits. L'enjeu portait sur la réponse à apporter au terrorisme après les attentats de 2015 et sur les effets d'une déchéance pouvant rendre une personne apatride.",
    ...
    ("PE-HTV-154173", "ecologie-agriculture", "Réforme du marché carbone européen (2023)",
     "Renforce le « marché carbone » de l'Union : les industries et les producteurs d'électricité doivent acheter des quotas pour leurs émissions de CO₂, dont le nombre total diminue chaque année, l'objectif passant à 62 % de baisse en 2030 par rapport à 2005 dans les secteurs couverts. La réforme étend le système au transport maritime, supprime progressivement de 2026 à 2034 les quotas gratuits accordés à l'industrie, et crée un second marché carbone à partir de 2027 sur les carburants du transport routier et le chauffage des bâtiments. L'enjeu : renchérir les émissions pour les faire baisser plus vite, la question débattue étant le coût supporté par les entreprises et, via ce second marché, par les ménages pour se chauffer et se déplacer.",
     "Pièce maîtresse du paquet climat « Fit for 55 », vote d'avril 2023."),
    ("PE-HTV-154076", "travail", "Transparence des salaires (2023)",
     "Directive obligeant les entreprises à plus de transparence sur les rémunérations pour réduire l'écart de salaire entre femmes et hommes : information du candidat sur le salaire proposé ou sa fourchette avant l'entretien d'embauche, interdiction de lui demander son salaire antérieur, droit pour un salarié de connaître les rémunérations moyennes à poste équivalent, et déclaration de leurs écarts de salaire par les employeurs de 100 salariés et plus. L'enjeu : rendre visibles, et corriger, les inégalités de salaire à travail égal.",
    ...
    ("PE-HTV-184178", "ecologie-agriculture", "Cadre pour la neutralité climatique : objectif 2040 (2026)",
     "Modifie la loi européenne sur le climat pour fixer un objectif de réduction des émissions nettes de gaz à effet de serre de 90 % en 2040 par rapport à 1990, sur la trajectoire vers la neutralité carbone en 2050. Le texte adopté prévoit plusieurs souplesses : à partir de 2036, jusqu'à cinq points de pourcentage de la réduction peuvent provenir de crédits carbone internationaux ; le marché carbone du chauffage des bâtiments et des carburants est reporté de 2027 à 2028 ; des absorptions de carbone nationales peuvent compenser une partie des émissions difficiles à réduire ; la Commission évalue les progrès tous les deux ans et peut proposer de modifier l'objectif. L'enjeu : la vitesse de la transition climatique d'ici 2040, entre ambition environnementale et coût pour l'économie et les ménages.",
    ...
    ("VTANR5L16V1533", "ecologie-agriculture", "Relance du nucléaire (2023)",
     "Accélère et simplifie les procédures administratives pour construire de nouveaux réacteurs nucléaires à proximité de centrales existantes : délais raccourcis, autorisations facilitées. Le texte abroge également deux objectifs inscrits dans le code de l'énergie depuis 2015 : la réduction à 50 % de la part du nucléaire dans la production d'électricité à l'horizon 2035, et le plafonnement de la capacité nucléaire autorisée à 63,2 gigawatts. L'enjeu : permettre une relance rapide de la construction nucléaire pour produire une électricité bas-carbone, mis en balance avec les questions de sûreté, de gestion des déchets et le choix, de long terme, de miser sur cette énergie.",
     "Vote sur le texte issu de la commission mixte paritaire. Les groupes LFI et Écologiste ont voté contre, rejoints par quelques voix d'autres groupes ; le groupe Socialiste s'est abstenu."),
    ...
    ("VTANR5L17V7454", "institutions", "Autonomie de la Corse (2026)",
     "Révision de la Constitution dotant la Corse d'un statut d'autonomie au sein de la République. La Collectivité de Corse pourrait être habilitée à adapter les lois et règlements à ses spécificités, et aussi à fixer elle-même les normes dans les matières relevant de ses compétences. La Constitution exclut certains domaines (nationalité, droits civiques, garanties des libertés publiques, justice, droit et procédure pénale, politique étrangère, défense, sécurité et ordre publics, monnaie, droit électoral) ; les matières ouvertes, les conditions et les contrôles restent à définir par une loi organique. Les électeurs inscrits en Corse seraient consultés sur le projet de statut. L'enjeu : reconnaître les particularités corses par un pouvoir normatif propre, une question qui touche au caractère unitaire de la République et à l'égalité entre les territoires.",
     "Première lecture. Une révision constitutionnelle doit ensuite être votée dans les mêmes termes par le Sénat, puis approuvée par le Congrès ou par référendum ; l'étendue réelle de l'autonomie dépendra en outre d'une loi organique non encore votée. Les positions habituelles s'y sont inversées : LFI a voté pour, le RN contre."),
    ...
    ("VTANR5L17V1303", "institutions", "Parité dans les petites communes (2025)",
     ...
     "Deuxième lecture, 206 voix pour et 181 contre, puis promulguée le 21 mai 2025 pour les municipales de 2026 ; environ 70 % des communes sont concernées. La gauche et le centre ont voté pour ; le Rassemblement national, la Droite Républicaine et l'UDR ont voté contre ; Horizons s'est abstenu."),
    ...
    ("VTANR5L16V875", "sante", "Accès direct aux paramédicaux : loi Rist (2023)",
     "Ouvre un accès direct, sans prescription médicale préalable, aux infirmiers en pratique avancée, aux masseurs-kinésithérapeutes (dans la limite de dix séances par patient) et aux orthophonistes, lorsqu'ils exercent en établissement de santé ou médico-social ou dans une structure d'exercice coordonné ; un compte rendu des soins est adressé au médecin traitant. Le texte élargit aussi les compétences des infirmiers pour la prise en charge des plaies. L'enjeu : raccourcir les délais d'accès aux soins face au manque de médecins, la question débattue étant la coordination des soins autour du médecin traitant.",
     None),
    ...
    ("VTANR5L17V600", "sante", "Ratios de soignants par patient (2025)",
     "Pose le principe d'un nombre minimum de soignants par patient hospitalisé, défini par spécialité et par type d'activité de soins. Les ratios eux-mêmes ne sont pas fixés par la loi : ils seront établis par décret, après avis de la Haute Autorité de santé, pour une durée maximale de cinq ans. Lorsqu'un service ne peut respecter les ratios plus de trois jours, le chef d'établissement en informe l'agence régionale de santé, sans sanction prévue. L'enjeu : la sécurité des patients et les conditions de travail des soignants, mis en balance avec le coût et la pénurie de personnel disponible.",
     "Adoption définitive : le texte du Sénat a été adopté sans modification. Le dispositif entre en vigueur le 1ᵉʳ janvier 2027 et dépend d'un décret d'application, ce qui explique les nombreuses abstentions."),
    ...
    ("VTANR5L17V7261", "sante", "Reconnaissance de la responsabilité de l'État et indemnisation des victimes du chlordécone",
     "Reconnaît la responsabilité de l'État dans le préjudice sanitaire, moral, écologique et économique subi par la Guadeloupe et la Martinique et leurs populations, résultant de l'autorisation du chlordécone (un insecticide utilisé dans les bananeraies antillaises jusqu'en 1993, alors que sa toxicité et sa persistance dans les sols et l'eau étaient déjà documentées) et de son usage prolongé. Le texte n'ouvre pas de droit à indemnisation : il donne un an au Gouvernement pour remettre au Parlement un rapport évaluant l'opportunité et la faisabilité d'étendre le fonds existant d'indemnisation des victimes de pesticides aux personnes atteintes d'une maladie liée au chlordécone, la liste des maladies étant renvoyée à un décret en Conseil d'État. Un second rapport doit porter sur la présence de chlordécone dans les sols du territoire national. L'enjeu : la réparation d'un préjudice sanitaire de long terme (le chlordécone, un perturbateur endocrinien, reste présent dans les sols antillais pour plusieurs siècles), le débat portant sur l'ampleur et le financement de cette indemnisation.",
    ...
    ("VTANR5L17V7303", "sante", "Contamination au cadmium des engrais et de l'alimentation (2026)",
     "Abaisse la teneur maximale en cadmium (un métal lourd toxique) autorisée dans les engrais phosphatés, exprimée par kilogramme d'anhydride phosphorique : de 90 mg/kg actuellement en France, la limite européenne étant de 60 mg/kg, à 40 mg/kg au 1ᵉʳ janvier 2027, puis 20 mg/kg au 1ᵉʳ janvier 2030. L'enjeu : réduire la contamination des sols agricoles et, à terme, de la chaîne alimentaire, mis en balance avec le coût de la mise aux normes pour les fabricants d'engrais et les agriculteurs.",
    ...
    ("VTANR5L17V4515", "sante", "Nutri-Score obligatoire sur les emballages alimentaires (2025)",
     "Aurait rendu obligatoire l'affichage du Nutri-Score (l'étiquetage nutritionnel simplifié, noté de A à E) sur les emballages alimentaires ; il est aujourd'hui facultatif, en France comme dans le reste de l'Union européenne. Pour rendre cette obligation effective, l'amendement créait une contribution de 5 % du chiffre d'affaires hors taxes, versée à l'Assurance maladie, due par les entreprises ne respectant pas l'obligation d'affichage ; les produits bénéficiant d'un signe national ou européen de qualité en étaient exclus. L'enjeu : mieux informer les consommateurs sur la qualité nutritionnelle des produits, mis en balance avec les contraintes pour les industriels et les réticences de certaines filières.",
    ...
    ("VTANR5L15V351", "education", "Parcoursup : accès à l'université (loi ORE, 2018)",
     "Donne un cadre légal à la nouvelle procédure nationale de préinscription dans l'enseignement supérieur, mise en œuvre par la plateforme Parcoursup qui remplace APB : les établissements peuvent examiner les dossiers des candidats, classer les candidatures dans les filières où les demandes dépassent les capacités d'accueil, et conditionner l'inscription à un parcours d'accompagnement. La loi rattache par ailleurs les étudiants au régime général de sécurité sociale et crée une contribution vie étudiante et de campus. L'enjeu : mieux orienter et réduire l'échec en licence, la critique portant sur l'instauration d'une forme de sélection à l'entrée de l'université.",
     None),
    ...
    ("VTANR5L17V7397", "education", "Bourses étudiantes et précarité (2026)",
     "Inscrit dans la loi deux garanties sur les bourses de l'enseignement supérieur sur critères sociaux : une revalorisation annuelle au moins égale à l'inflation (hors tabac), portant à la fois sur les montants et sur les plafonds de ressources ouvrant droit à la bourse, et un versement en douze mensualités sur l'année. Le texte prévoit aussi un rapport sur une modulation pour les primo-arrivants dans les filières exigeant un investissement matériel important. L'enjeu : le pouvoir d'achat des étudiants boursiers, notamment pendant l'été, mis en balance avec le coût pour les finances publiques.",
     "Proposition de loi adoptée le 11 juin 2026 par 75 voix contre 1 dans un hémicycle peu rempli (91 votants). Le texte doit encore être examiné par le Sénat."),
    ...
    ("VTANR5L17V1550", "education", "Scolarisation des élèves handicapés (2025)",
     "Inscrit dans la loi les « pôles d'appui à la scolarité », un par département, qui remplaceront les pôles inclusifs d'accompagnement localisés en 2027 : ils organisent la mise en œuvre des décisions d'accompagnement et appuient les équipes éducatives. Le texte oblige aussi l'État à affecter effectivement un accompagnant dans le mois suivant la notification de la décision, impose une formation des accompagnants avant leur prise de fonction, généralise le livret de parcours inclusif et rend obligatoire un module sur le handicap dans la formation des enseignants. L'enjeu : mieux scolariser les enfants handicapés, la critique portant sur les moyens réels et sur le statut des accompagnants.",
     None),
    ("VTANR5L17V840", "education", "Égalité des chances pour les écoles de service public (2025)",
     "Proroge l'expérimentation des concours externes spéciaux dits « Talents », qui réservent entre 10 % et 15 % des places de cinq écoles de service public (Institut national du service public, INET, EHESP, École nationale supérieure de police, École nationale d'administration pénitentiaire) à des candidats remplissant des conditions de ressources, avec les mêmes jurys, programmes et épreuves que le concours externe classique. L'enjeu : diversifier l'origine sociale des recrutements de la haute fonction publique, la mesure étant contestée par ses opposants comme une voie d'accès réservée à côté du concours de droit commun.",
     "L'expérimentation, ouverte par une ordonnance de mars 2021, avait expiré fin 2024. La loi la proroge jusqu'au 31 août 2028."),
    ("VTANR5L17V5845", "education", "Enseignement de la défense nationale à l'école (2026)",
     "Complète l'enseignement de défense déjà obligatoire au collège et au lycée : il devra contribuer à la formation civique et morale des élèves et à la compréhension des enjeux contemporains de défense, de sécurité et de résilience nationale. Il pourra associer des réservistes, opérationnels ou citoyens, et les correspondants défense désignés par les communes. Son contenu fera l'objet d'un référentiel arrêté par le ministre de l'éducation nationale, après consultation du Conseil supérieur des programmes. L'enjeu : donner un cadre national à cet enseignement et y faire intervenir le monde militaire.",
     "Première lecture, lors d'une journée réservée au groupe Les Démocrates ; scrutin peu suivi (56 votants sur 577). Ont voté contre les groupes La France insoumise, Socialistes et Écologiste et Social."),
    ...
    ("VTANR5L16V236", "travail", "Réforme de l'assurance chômage (2022)",
     "Autorise le Gouvernement à fixer par décret les règles de l'assurance chômage jusqu'au 31 décembre 2023 au plus tard, y compris une modulation selon la conjoncture ; les paramètres n'étaient pas écrits dans la loi. Le texte adopté instaure par ailleurs une présomption de démission pour le salarié qui abandonne son poste et ne reprend pas le travail après mise en demeure, modifie les règles d'électorat aux élections professionnelles et réorganise la validation des acquis de l'expérience. L'enjeu : inciter au retour à l'emploi lorsque le marché est favorable, une logique contestée comme une baisse des droits des demandeurs d'emploi.",
     "Vote en première lecture. La modulation elle-même n'est pas écrite dans la loi : elle a été fixée ensuite par un décret de janvier 2023, qui réduit de 25 % la durée d'indemnisation, avec un plancher de six mois."),
    ("VTANR5L16V2965", "travail", "France Travail et contrat d'engagement des allocataires du RSA (2023)",
     "Crée France Travail, qui remplace Pôle emploi et coordonne un réseau d'acteurs de l'insertion, et inscrit dans le contrat d'engagement des demandeurs d'emploi, dont les allocataires du RSA, une durée hebdomadaire d'activité d'au moins quinze heures (formation, accompagnement, immersion en entreprise). Cette durée peut être réduite, ou supprimée, selon la situation de la personne : état de santé, handicap, invalidité, parent isolé sans solution de garde pour un enfant de moins de douze ans. Le non-respect des engagements du contrat peut entraîner la suspension de l'allocation. L'enjeu : favoriser le retour à l'emploi des allocataires, une mesure jugée par ses opposants comme une contrainte pénalisant les plus précaires.",
     "Vote sur le texte issu de la commission mixte paritaire."),
    ...
    ("VTANR5L17V6572", "sante", "Médicaments contre les cancers de l'enfant (2026)",
     "Crée une contribution de 0,10 % sur le chiffre d'affaires des laboratoires exploitant des médicaments remboursables en France, les médicaments orphelins étant exclus de l'assiette, affectée au financement d'un programme de soutien à l'innovation thérapeutique contre les cancers et les maladies rares de l'enfant. Le contenu de ce programme n'est pas défini par la loi : ses modalités relèvent d'un décret en Conseil d'État, et le Gouvernement rend compte chaque année au Parlement de l'utilisation du produit de la contribution. Le texte prévoit aussi un rapport évaluant l'abaissement de 18 à 12 ans de l'âge minimal d'accès aux essais cliniques en cancérologie. L'enjeu : financer la recherche sur des traitements pédiatriques peu développés, faute de rentabilité pour l'industrie.",
    ...
    ("VTANR5L15V729", "ecologie-agriculture", "Loi EGalim : revenu agricole et alimentation (2018)",
     "Cherche à mieux rémunérer les agriculteurs : les prix payés aux producteurs doivent davantage tenir compte des coûts de production, via les contrats et des indicateurs de référence. Le texte autorise en outre le Gouvernement à relever par ordonnance, à titre expérimental pendant deux ans, le seuil de revente à perte et à encadrer les promotions en valeur et en volume. Il fixe aussi, au plus tard le 1ᵉʳ janvier 2022, une part de 50 % de produits durables ou sous label dans la restauration collective publique, dont 20 % issus de l'agriculture biologique, et comporte des mesures sur le bien-être animal. L'enjeu : le revenu paysan et le contenu de l'assiette.",
    ...
    ("VTANR5L17V10", "budget", "Réforme du barème de l'impôt sur le revenu pour augmenter le reste à vivre (2024)",
     "Amendement au budget 2025 remplaçant le barème de l'impôt sur le revenu par un barème à quatorze tranches, allant de 5 % à 70 %, pour alléger l'impôt des foyers gagnant moins de 4 000 € net par mois et augmenter leur reste à vivre, l'allégement étant financé par les tranches supérieures. Selon ses auteurs, la réforme rapporterait 5,7 milliards d'euros. L'enjeu : le degré de progressivité de l'impôt sur le revenu et le niveau d'imposition des hauts revenus.",
     None),
    ...
    ("VTANR5L14V1195", "defense", "Frappes aériennes en Syrie contre Daech (2015)",
     "Autorisation de prolonger les frappes aériennes françaises au-dessus de la Syrie contre l'organisation État islamique, engagées le 27 septembre 2015 et intensifiées après les attentats du 13 novembre 2015. L'enjeu : étendre au territoire syrien l'intervention anti-Daech menée en Irak.",
     "Vote quasi unanime."),
    ("VTANR5L16V650", "defense", "Soutien à l'Arménie face à l'Azerbaïdjan (2022)",
     "Résolution (sans portée juridique contraignante) condamnant l'agression militaire menée par l'Azerbaïdjan les 13 et 14 septembre 2022 contre les régions sud et sud-est du territoire de la République d'Arménie, appelant au retrait des forces azerbaïdjanaises et à la libération des prisonniers de guerre arméniens, et invitant le Gouvernement à envisager des sanctions économiques individuelles si les attaques se poursuivaient. L'enjeu : la position de la France face à l'atteinte à l'intégrité territoriale de l'Arménie et à la sécurité des populations arméniennes, y compris au Haut-Karabakh.",
    ...
    ("VTANR5L17V683", "defense", "Condamnation de la répression du régime iranien (2025)",
     "Résolution par laquelle l'Assemblée nationale condamne les violations des droits humains en Iran et les violences infligées aux femmes et aux filles, renouvelle son soutien au mouvement « Femme, Vie, Liberté », et demande l'inscription des Gardiens de la révolution islamique sur la liste européenne des organisations terroristes, la fin des exécutions, la libération des personnes arrêtées arbitrairement et l'abrogation des lois discriminatoires. L'enjeu : la position de l'Assemblée face au régime iranien.",
     "Adoptée à l'unanimité des votants. Résolution au titre de l'article 34-1 de la Constitution : elle exprime une position sans effet juridique contraignant."),
    ("VTANR5L16V1456", "defense", "Conflit israélo-palestinien : résolution « deux États » (2023)",
     ...
     "Rejetée (71 pour, 199 contre). Texte déposé par le groupe Gauche démocrate et républicaine (députés communistes), rapporteur Jean-Paul Lecoq, examiné dans sa journée d'initiative parlementaire. Le terme d'« apartheid » retenu par le texte a concentré l'opposition d'une large partie de l'hémicycle, y compris du groupe Socialiste."),
    ("PE-HTV-179048", "defense", "Gaza : famine, otages et solution à deux États (PE, 2025)",
     "Résolution du Parlement européen sur la guerre à Gaza. Elle demande un cessez-le-feu, la libération immédiate et sans condition des otages, l'acheminement sans entrave de l'aide humanitaire et le rétablissement du mandat et du financement de l'UNRWA. Elle soutient la suspension partielle du volet commercial de l'accord d'association entre l'Union et Israël, demande des sanctions contre deux ministres israéliens et contre les colons violents, invite les États membres à envisager la reconnaissance de l'État de Palestine et encourage l'exécution des mandats d'arrêt de la Cour pénale internationale. L'enjeu : le degré de pression que l'Union exerce sur le gouvernement israélien, en même temps que l'aide humanitaire et la libération des otages.",
     None),
    ("PE-HTV-172867", "defense", "Défense européenne : attentes du Parlement avant le Livre blanc (PE, 2025)",
    ...
    ("PE-HTV-181587", "defense", "Programme pour l'industrie de défense européenne : EDIP (PE, 2025)",
     "Premier programme européen dédié à l'industrie de défense, doté de 1,5 milliard d'euros : achats groupés entre États membres, montée en cadence de la production d'armement, « projets de défense d'intérêt commun » devant associer au moins quatre États membres, et un instrument de soutien à l'Ukraine doté de 300 millions d'euros. Pour être financé, un produit ne peut comporter plus de 35 % de composants originaires de pays tiers non associés. Le programme prend la suite des mesures d'urgence adoptées pour les munitions et les achats communs. L'enjeu : bâtir une base industrielle de défense européenne commune.",
     None),
    ...
    ("VTANR5L17V3620", "femmes", "Rapport sur la prise en charge des protections périodiques après 26 ans (2025)",
     ...
     None),
    ("VTANR5L17V4613", "femmes", "Rapport sur l'extension au-delà de 26 ans de la prise en charge des protections périodiques (2025)",
     "Amendement au budget de la Sécurité sociale 2026 rétablissant un article qui demandait au Gouvernement de remettre au Parlement, dans un délai de six mois, un rapport évaluant les effets financiers d'une prise en charge des protections périodiques réutilisables au-delà de 26 ans. Il ne créait pas lui-même de remboursement : la prise en charge existe déjà depuis le budget de la Sécurité sociale pour 2024 pour les personnes de moins de 26 ans et les bénéficiaires de la complémentaire santé solidaire. L'enjeu : documenter le coût d'une extension au-delà de cette limite d'âge, dans le cadre de la lutte contre la précarité menstruelle.",
     None),
...
SENS = {
    ...
    "VTANR5L17V2957": ("adopter la loi (réautoriser l'acétamipride, faciliter réserves d'eau et agrandissements d'élevages)",
                       "rejeter le texte"),
    "VTANR5L17V8427": ("adopter la loi (dérogations ciblées pour l'acétamipride et le flupyradifurone, stockage de l'eau, préférence européenne en restauration collective)",
                       "rejeter le texte"),
    ...
    "VTANR5L17V7987": ("présumer que les policiers et gendarmes ayant fait usage de leur arme ont respecté les conditions légales",
    ...
    "VTANR5L16V2965": ("créer France Travail et inscrire au moins 15 h d'activité hebdomadaire dans le contrat d'engagement des allocataires du RSA",
                       "s'y opposer"),
    ...
    "VTANR5L17V4114": ("affecter aux départements une part plus grande de la taxe sur les assurances pour financer les pompiers", "maintenir la fraction actuelle de 6,45 %"),
    ...
    "VTANR5L17V3958": ("supprimer progressivement ce tarif réduit d'ici 2028", "le maintenir"),
    ...
    "VTANR5L17V3830": ("supprimer les malus CO2 et au poids à l'immatriculation", "les maintenir"),
    ...
    "VTANR5L17V7303": ("abaisser la teneur en cadmium autorisée dans les engrais phosphatés",
                       "maintenir la norme française actuelle de 90 mg/kg d'anhydride phosphorique"),
    ...
    "VTANR5L17V4613": ("demander au Gouvernement un rapport sur l'extension de cette prise en charge au-delà de 26 ans", "rejeter cette demande de rapport"),
