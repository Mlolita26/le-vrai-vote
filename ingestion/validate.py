...
def controles_scrutins_an(base: Path, dossier_dumps: Path):
    ...
    if n_vc:
        verifier("92 votes clés répartis sur 11 thématiques",
                 n_vc == 92 and cur.execute("SELECT COUNT(*) FROM thematiques").fetchone()[0] == 11)
        ...
        verifier("positions de groupes extraites pour les 92 scrutins des votes clés",
