# Rédiger et vérifier un vote clé
...
C'est le document le plus important de ce dossier. À lire avant d'ajouter ou de modifier
un vote clé dans `ingestion/seed_votes_cles.py`. La sélection du vote, elle, est traitée
dans `07-choisir-un-vote-cle.md` ; les incidents complets sont datés dans
`15-journal-des-problemes.md`.
